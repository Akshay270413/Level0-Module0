...
if __name__ == '__main__':
    ...
    # 2. Call the set_background() function with your variable i my_dog6nside of the parenthesis
    #    for example, set_background(bg_image)
    set_background("bigEyedCat.gif")
    # 3. Make a new turtle
    my_dog6 = turtle.Turtle()
    # 4. Set the turtle color and pen color to red (or any color you want)
    #    using .color('red', 'red')
    my_dog6.color('red')
    my_dog6.pencolor('blue')
    ...
    #    and initialize them:
    left_eye  = Eye(eye=my_dog6, x=-31, y=13, radius=30)
    right_eye = Eye(eye=my_dog6, x=44, y=3, radius=30)
